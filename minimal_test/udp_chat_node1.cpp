/**
 * @file udp_chat_node1.cpp
 * @brief UDP Chat Application with Auto-Discovery - Node 1
 ...
 * 
 * Compilation: g++ -o node1.exe udp_chat_node1.cpp -lws2_32 -std=c++11
 * Usage: ./node1.exe
 */
...
int main() {
    std::cout << "=====================================\n";
    std::cout << "  UDP Chat Node 1 - Auto Discovery  \n";
