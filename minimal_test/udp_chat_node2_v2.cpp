/**
 * @file udp_chat_node2_v2.cpp
 * @brief UDP Chat Application with Auto-Discovery - Node 2 (Improved Version)
 ...
 * 
 * Compilation: g++ -o node2_v2.exe udp_chat_node2_v2.cpp -lws2_32 -std=c++11
 * Usage: ./node2_v2.exe
 */
...
int main() {
    std::cout << "=====================================\n";
    std::cout << "  UDP Chat Node 2 v2 - Auto Discovery\n";
